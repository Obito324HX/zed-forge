    ...
    (
      <div
        style={{
          ...
          backgroundImage: "radial-gradient(circle at 25% 25%, #14141c 0%, #0A0A0F 60%)"
        }}
      >
        <svg width="560" height="82" viewBox="0 0 488 72" fill="none">
          <path d="M8 8 L52 8 L52 16 L20 56 L52 56 L52 64 L8 64 L8 56 L40 16 L8 16 Z" fill="#F0F0F5" />
          <path d="M62 8 L62 64 L106 64 L106 56 L70 56 L70 40 L102 40 L102 32 L70 32 L70 16 L106 16 L106 8 Z" fill="#F0F0F5" />
          <path
            ...
            fillRule="evenodd"
          />
          <path d="M184 8 L192 8 L180 34 L188 34 L176 64 L182 36 L174 36 Z" fill="#C1552C" />
          <path d="M194 8 L194 64 L202 64 L202 40 L234 40 L234 32 L202 32 L202 16 L238 16 L238 8 Z" fill="#F0F0F5" />
          <path
          ...
          <path
            ...
            fill="#F0F0F5"
          />
          <path d="M436 8 L436 64 L480 64 L480 56 L444 56 L444 40 L476 40 L476 32 L444 32 L444 16 L480 16 L480 8 Z" fill="#F0F0F5" />
        </svg>
        <div
          style={{
            marginTop: 28,
