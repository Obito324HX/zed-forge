...
export default function ThankYouPage() {
 ...
 <div className="mx-auto grid h-16 w-16 place-items-center bg-ff-green text-3xl font-bold text-black">✓</div>
 ...
 <Link href="/" className="mt-8 inline-flex border border-ff-border px-5 py-3 text-sm font-semibold text-ff-text hover:bg-ff-surface-2">
 ← Back to zed-forge
 </Link>
 </section>
 </main>
