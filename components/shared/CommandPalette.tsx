...
export function CommandPalette() {
 ...
 <>
 {notice ? (
 <div className="fixed bottom-4 left-1/2 z-[100] -translate-x-1/2 border border-ff-border bg-ff-surface px-4 py-2 text-sm text-ff-text">
 {notice}
 </div>
 ) : null}
 {open ? (
 ...
 <Command
 className="mx-auto mt-24 max-w-xl overflow-hidden border border-ff-border bg-ff-surface text-ff-text shadow-2xl"
