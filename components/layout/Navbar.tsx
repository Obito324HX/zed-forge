...
export function Navbar() {
 ...
 className={cn(
 "focus-ring relative px-3 py-1.5 text-sm font-medium transition-colors hover:text-ff-text dark:hover:text-ff-text",
 ...
 className="absolute inset-0 bg-ff-surface-2"
 ...
 <Link href="/" className="focus-ring text-ff-text" aria-label="zed-forge home">
 ...
 <Search size={13} />
 <span>Search</span>
 <kbd className="pointer-events-none inline-flex h-4 select-none items-center gap-0.5 border border-ff-border bg-ff-surface-2 px-1 font-mono text-[9px] font-medium text-ff-muted">
 {shortcutText}
 </kbd>
 </button>
 <ThemeToggle />
 ...
 <button
 onClick={openSearch}
 className="focus-ring p-2 text-ff-text"
 aria-label="Search"
 >
 <Search size={22} />
 </button>
